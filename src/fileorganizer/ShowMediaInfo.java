...
class ShowMediaInfo {
    ...
    public static void ByFileName(String FileName) throws Exception {
        String To_Display = "";
...
//        To_Display += MI.Get(MediaInfo.StreamKind.General, 0, "FileSize", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
    ...
    public static void ByBuffer_LocalFile(String FileName) throws Exception {
    ...
    public static void ByBuffer_URL(String FileName) throws Exception {
